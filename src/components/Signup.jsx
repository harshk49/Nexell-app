...
const Signup = () => {
  ...
  const buttonClasses =
    "px-6 py-2.5 border border-gray-700 rounded-lg text-black flex items-center gap-2 bg-[#A3F600] hover:bg-black hover:text-white hover:border-[#A3F600] transition-all duration-300 text-sm";
  ...
  return (
    <div className="absolute inset-0 min-h-screen w-full flex items-center justify-center bg-[#A3F600]">
      <div className="w-full max-w-5xl mx-auto min-h-[650px] rounded-2xl border-2 border-gray-900 flex flex-col md:flex-row p-4 md:p-8 gap-4 md:gap-8 bg-black shadow-[0_0_40px_rgba(0,0,0,0.3),0_0_80px_rgba(0,0,0,0.2),0_0_120px_rgba(0,0,0,0.1)] overflow-hidden">
        <div className="hidden md:block flex-1 rounded-xl border-2 border-gray-900 bg-[#A3F600] shadow-[inset_0_0_20px_rgba(255,255,255,0.2),0_0_30px_rgba(255,255,255,0.15),0_0_50px_rgba(255,255,255,0.1)]" />
